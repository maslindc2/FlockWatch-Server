...
class FetchRetry {
     ...
     * @returns The Post Promise
     */
    private async fetchWithRetry(URL: string, retries: number, timeoutMs: number, baseDelay: number, options: RequestInit): Promise<Response> {
     ...
     * @returns The Post Promise
     */
    public async postRetry(URL: string, body: any, retries:number, timeoutMs: number, baseDelay: number):Promise<Response | undefined> {
        try {
